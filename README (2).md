...
**[Play it →](https://YOUR-USERNAME.github.io/nose-wars/)**
...
1. Rename `nose_wars_12.html` to `index.html` (or leave it and use the longer URL)
2. Push to GitHub
...
Built collaboratively with [Claude](https://claude.ai). Every nose drawn from scratch in canvas, every ult tuned over a lot of back-and-forth.
